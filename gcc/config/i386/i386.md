...
;;TODO handle stack erase for 32-bit
(define_insn "stack_erasesi"
...
(define_insn "stack_erase_pushdi"
  [(unspec_volatile [(match_operand:DI 0 "register_operand" "r")
                     (match_operand:DI 1 "register_operand" "+r")
                     (match_operand:DI 2 "register_operand" "r")]
                    UNSPECV_STACK_ERASE)]
...
;;stack erase enabled function is responsible for erasing callee return address
;; single insn, doesn't need \n block
(define_insn "stack_erase_ret_addrsi"
  [(unspec_volatile [(match_operand:SI 0 "register_operand" "r")]
                    UNSPECV_STACK_ERASE)]
  ""
  "\n#START STACK ERASE RET ADDR\nmovl $0,-4(%%esp)\n#END STACK ERASE RET ADDR"
  ;;"\n#START STACK ERASE RET ADDR\n#END STACK ERASE RET ADDR"
)

;;stack erase enabled function is responsible for erasing callee return address
;; single insn, doesn't need \n block
(define_insn "stack_erase_ret_addrdi"
  [(unspec_volatile [(match_operand:DI 0 "register_operand" "r")]
                    UNSPECV_STACK_ERASE)]
  ""
  "\n#START STACK ERASE RET ADDR\nmovq $0,-8(%%rsp)\n#END STACK ERASE RET ADDR"
